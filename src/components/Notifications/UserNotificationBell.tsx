  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {notificationCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-secondary text-[11px] font-bold text-white border border-white dark:border-black">
            {notificationCount}
          </span>
        )}
      </button>
