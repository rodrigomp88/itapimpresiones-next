...
const SystemHealth = () => {
  ...
  if (loading)
    return (
      <div className="animate-pulse h-20 bg-zinc-100 dark:bg-zinc-800 rounded-xl" />
    );
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {/* Permission Check */}
        <div
          className={`p-4 rounded-lg flex items-start gap-3 border ${health.isInAdminsCollection ? "bg-green-50 border-green-200 dark:bg-green-900/10 dark:border-green-800" : "bg-yellow-50 border-yellow-200 dark:bg-yellow-900/10 dark:border-yellow-800"}`}
        >
        ...
        {/* Notification Check */}
        <div
          className={`p-4 rounded-lg flex items-start gap-3 border ${health.hasFcmToken ? "bg-green-50 border-green-200 dark:bg-green-900/10 dark:border-green-800" : "bg-red-50 border-red-200 dark:bg-red-900/10 dark:border-red-800"}`}
        >
          {health.hasFcmToken ? (
            <FaCheckCircle className="text-green-500 mt-1" />
          ) : (
