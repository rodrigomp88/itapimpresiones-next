...
const ProductFilter: React.FC<ProductFilterProps> = ({
  ...
  const colors = ["Todos", "Blanco", "Negro", "Rojo", "Azul", "Verde", "Amarillo"];
  ...
  return (
    <div className="sticky top-24 flex flex-col gap-6 bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
            ...
            <div className="grid grid-cols-6 gap-2">
              {colors.map((color) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full transition-all ${colorMap[color]} ${selectedColor === color
      ...
      {/* Bag Type Filter - Only show for Bolsas category */}
            ...
            <div className="flex flex-col gap-2">
              {bagTypes.map((type) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors text-left ${selectedBagType === type
