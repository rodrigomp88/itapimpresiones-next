              ...
              <form onSubmit={handleSubmitReview} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-md shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500" // Corregido: "class" a "className" y añadido estilos básicos
