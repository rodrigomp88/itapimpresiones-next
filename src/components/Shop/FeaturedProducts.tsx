    ...
    return isMobile ? (
        ...
        <div className="flex overflow-x-auto gap-4 pb-4 no-scrollbar -mx-4 px-4 snap-x">
            {products.map((product) => (
                <div key={product.id} className="min-w-[240px] bg-surface-light dark:bg-surface-dark rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm snap-center">
