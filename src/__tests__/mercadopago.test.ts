...
describe('MercadoPago Integration', () => {
  beforeEach(() => {
    ...
    process.env.MERCADO_PAGO_ACCESS_TOKEN = 'TEST-1234567890123456-123456-7890123456789012345678901234567890';
  ...
  describe('MercadoPago SDK', () => {
    ...
    it('should create payment preference with correct data structure', async () => {
      ...
      const testData = {
        ...
        back_urls: {
          success: 'http://localhost:3000/checkout/success?order_id=test-order-123',
          failure: 'http://localhost:3000/checkout/failure?order_id=test-order-123',
          pending: 'http://localhost:3000/checkout/pending?order_id=test-order-123',
        },
    ...
    it('should retrieve payment information correctly', async () => {
      ...
      expect(paymentInstance.get).toHaveBeenCalledWith({ id: 'test-payment-id' });
