...
const SubmissionsClient: React.FC<SubmissionsClientProps> = ({
  initialSubmissions,
}) => {
            ...
            {filter === item.id && (
              <span className="ml-1 bg-white/20 px-1.5 py-0.5 rounded-full text-xs">
                {item.id === "all"
                  ...
                  : initialSubmissions.filter((s) => s.formType === item.id)
                      .length}
              </span>
            )}
          </button>
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`p-2.5 rounded-xl ${getFormTypeColor(submission.formType)} bg-opacity-20`}
                    >
                  ...
                  <span
                    className={`px-2.5 py-1 rounded-full text-xs font-semibold border ${getFormTypeColor(submission.formType)}`}
                  >
