        ...
        <div className="px-4 sm:px-6 lg:px-12 py-8 lg:py-12">
          <div className="@container">
            <div className="relative overflow-hidden rounded-2xl shadow-xl">
              <div
                className="flex min-h-[500px] flex-col gap-6 bg-cover bg-center bg-no-repeat items-center justify-center text-center px-6 sm:px-12 lg:px-16 py-16"
                style={{
                  backgroundImage:
                    'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url("https://lh3.googleusercontent.com/aida-public/AB6AXuCkf8ftoyMDQFE4hvxVQRbUHtg3KFAwua69-VWr6O8dQ8UampxOJbkrKMx8vY1G8x6lmGKFxnEGih7GeiAL4vOF2Z_hSA8XV0lp7yQGzzVtVhjv3saJ0ohrWGBiSH0V0efgVuIy2rDtcoRLLbcVI-xT_8DveDm3BMlX7r9jXMmj2ne6mybgZI5Ev64kxH34pwqxsZt2ptcLYzUsuczCmkWJvpLZxHv-dSV1jmfqsPEjJCmAGbURuM5bO3-kZC49QQzIfFjEAZ5mOxE")',
                }}
              >
                ...
                <div className="relative z-10 flex flex-col gap-6 max-w-4xl mx-auto">
                  ...
                  <p className="text-gray-200 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed">
                    ...
                    calidad, diseñada exclusivamente para unir y destacar a tu
                    equipo.
                  </p>
                  <div className="pt-4">
                    <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-4 text-center">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 text-sm">
                Contáctanos con tu idea. Te enviaremos una cotización detallada
        ...
        <section className="py-16 sm:py-24 max-w-screen-xl mx-auto">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-zinc-600 dark:text-zinc-400">
              Nos enorgullece haber colaborado con empresas de todos los
              tamaños.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <details className="group rounded-lg bg-white dark:bg-black p-4 shadow-sm border border-zinc-200 dark:border-zinc-800">
                  ...
                  <p className="group-open:animate-fadeIn mt-3 text-zinc-600 dark:text-zinc-400">
                    El tiempo de producción estándar es de 7 a 10 días hábiles
                    una vez aprobado el diseño y recibido el pago. Ofrecemos
                    servicios urgentes con un costo adicional.
                  </p>
                </details>
                <details className="group rounded-lg bg-white dark:bg-black p-4 shadow-sm border border-zinc-200 dark:border-zinc-800">
                  <summary className="flex cursor-pointer list-none items-center justify-between font-medium dark:text-white">
                  ...
                  <p className="group-open:animate-fadeIn mt-3 text-zinc-600 dark:text-zinc-400">
                    Para obtener la mejor calidad, preferimos archivos
                    vectoriales (.ai, .eps, .svg). También aceptamos imágenes de
                    alta resolución (.png, .psd, .jpg) de al menos 300 DPI. Si
                    no tienes un archivo de alta calidad, nuestro equipo de
                    diseño puede ayudarte.
                  </p>
                </details>
              </div>
            </div>
