...
const FeaturedProducts = dynamic(() => import("@/components/Shop/FeaturedProducts"), {
  loading: () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-pulse">
      {[...Array(6)].map((_, i) => (
        <div key={i} className="bg-slate-200 dark:bg-slate-700 rounded-lg h-64"></div>
      ))}
    </div>
  ),
});
    ...
    <MobileLayout>
      <div className="font-display bg-white dark:bg-slate-900 text-slate-900 dark:text-white antialiased">
        <main className="flex-1">
          {/* Carrusel - visible en móvil y desktop */}
          <section className="w-full">
            <HomeBanners />
          </section>
          
          {/* Novedades Destacadas - visible en móvil y desktop */}
          ...
          {/* Sección de servicios - visible en móvil y desktop */}
          <section className="w-full py-20 bg-white dark:bg-slate-900">
            <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
              <div className="text-center mb-16">
                <h2 className="text-slate-900 dark:text-white text-3xl md:text-4xl font-bold tracking-tight mb-4">
          ...
          {/* Sección "¿Por qué elegirnos?" - visible en móvil y desktop */}
          <section className="w-full py-24 bg-white dark:bg-slate-900">
            <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="p-8 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 hover:shadow-md transition-shadow">
          ...
          {/* Sección de testimonios - visible en móvil y desktop */}
            ...
            <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16 grayscale opacity-60 hover:opacity-100 transition-opacity duration-300">
                <Image
                  ...
                  onError={(e) => {
                    e.currentTarget.src = 'data:image/svg+xml;base64,';
                  }}
                />
                <Image
                  width={150}
