...
// Email configuration (from .env.itap-shop)
const EMAIL_USER = 'itapimpresiones@gmail.com';
const EMAIL_PASS = 'hdoc uhtm boug cmmi';
...
async function testEmail() {
  const mailOptions = {
    from: `"Test Itap Impresiones" <${EMAIL_USER}>`,
